/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3bd06617d5612b7eaea33fe459635f92)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SCHEDULE_EVALUATION: DurableObjectNamespace<import("./src/server").EvaluationScheduler>;
		LINK_CLICK_TRACKER: DurableObjectNamespace<import("./src/server").LinkClickTracker>;
		R2BUCKET: R2Bucket;
		LINK_QUEUE: Queue;
		VIRTUAL_BROWSER: Fetcher;
		AI: Ai;
		DESTINATION_EVALUATION_WORKFLOW: Workflow<Parameters<import("./src/server").DestiEvalWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "VITE_BACKEND_HOST">> {}
}
