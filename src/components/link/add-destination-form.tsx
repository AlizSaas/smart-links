...
export function AddDestinationForm({
  ...
  const updateDestinationMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Geo destination added");
      // Reset form after successful addition
      setNewCountry("");
      setNewUrl("");
    },
    onError: () => {
      toast.error("Failed to add geo destination");
    },
  });

  const addGeoDestination = () => {
    if (newCountry && newUrl) {
      const newDestinations: DestinationsSchemaType = {
        ...destinations,
        [newCountry]: newUrl,
      };
      updateDestinationMutation.mutate(newDestinations);
    }
  };
